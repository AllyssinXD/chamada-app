    ...
    <div className="w-full min-h-screen flex items-center justify-center p-6">
      <div className="max-w-lg w-full bg-card border shadow-md rounded-2xl p-10 space-y-8">
        ...
        <p className="text-muted-foreground leading-relaxed text-center">
          É <span className="font-bold text-red-500">muito importante</span> que
          você permita a coleta da sua localização. Quando o navegador abrir a{" "}
          <span className="font-medium">tela de permissão</span>, clique em{" "}
          <strong>Permitir</strong> em todas as opções.
        </p>
      ...
      <div className="max-w-lg rounded-2xl border bg-card shadow-md p-8 flex flex-col gap-6">
        ...
        <ul className="space-y-4">
          ...
          <li className="flex items-start gap-3">
            ...
            <p>
              No celular, garanta que o <strong>GPS</strong> esteja ligado e que
              seu navegador tenha permissão no sistema.
            </p>
          </li>
        </ul>
